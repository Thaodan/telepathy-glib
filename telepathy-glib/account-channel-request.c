 ...
 * @self: a #TpAccountChannelRequest
 * @entity_type: the type of @identifier, typically %TP_ENTITY_TYPE_CONTACT
    ...
    const gchar *identifier)
{
  ...
  g_return_if_fail (entity_type != TP_ENTITY_TYPE_NONE);
  g_return_if_fail (!self->priv->requested);
 ...
 * @entity_type set to %TP_ENTITY_TYPE_CONTACT.
 *
 ...
 * tp_capabilities_supports_audio_call() with @entity_type set to
 * %TP_ENTITY_TYPE_ROOM.
 * -->
 *
